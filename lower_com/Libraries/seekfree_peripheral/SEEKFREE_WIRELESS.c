...
//            wireless_rx_index=0;
//    }
//            if(wireless_rx_buffer>=100)
//                g_loc=wireless_rx_buffer;
//            else if(wireless_rx_buffer>=10)
//                g_image_err=wireless_rx_buffer;
//            else
//                g_pre_post=wireless_rx_buffer;
//            if(0==g_pre_post)
//            {
//                //不作处理
//            }
//            else if((g_signpost!=0)&&(g_signpost!=g_pre_post)&&g_pre_post<200)
//            {
//                //下位机在状态机但是上位机预测出了其他东西
//                //g_pre_post=0;
//                g_loc=101;
//            }
//            else
//            {
//                g_signpost=g_pre_post;
//            }
